    ...
    public function individuals(string $key): Response
    {
        $individuals = [
            ...
            'campanii_ppc' => [
                ...
                'attributes' => ['Creare campanii Google Ads/Facebook Ads', 'Analiza competiție', 'Găsire cuvinte cheie', 'Optimizare', 'Copywriting', 'Configurare conversii', 'Raportul zilnic al campaniilor', 'Stabilirea optimă a bugetului', 'Remarketing campanii'],
                'price' => '300',
                'unit' => 'RON',
            ],
            'social_media_management' => [
                ...
                'attributes' => ['Postări frecvente pe Facebook și Instagram', 'Creare conținut (foto/video)', 'Copywriting', 'Îmbunătățire profiluri Social Media', 'Folosire imagini stock'],
                'price' => '500',
                'unit' => 'RON/Luna',
            ],
            'optimizare_seo' => [
                ...
                'attributes' => ['Optimizare tehnică', 'Optimizare cuvinte cheie', 'Optimizare imagini', 'Analiză competitori', 'Consultanță', 'Monitorizare cuvinte cheie', 'Research backlink-uri', 'Raporturi lunare'],
                'price' => '350',
                'unit' => 'RON',
            ],
            'copywriting' => [
