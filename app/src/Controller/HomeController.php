    ...
    public function individuals(string $key): Response
    {
        $individuals = [
            ...
            'web_design' => [
                ...
                'attributes' => ['Design responsive', 'Optimizat pentru mobil', 'Multiple limbi', 'Copywriting', 'Integrare social media', 'Optimizare SEO', 'Indexare pe Google', 'Conformare GDPR'],
                'price' => '750',
                'unit' => 'RON',
            ],
            'campanii_ppc' => [
                ...
                'attributes' => ['Creare campanii Google Ads/Facebook Ads', 'Analiza ompetitie', 'Gasire cuvinte cheie', 'Optimizare', 'Copywriting', 'Configurare conversii', 'Raportul zilnic al campaniilor', 'Stabilirea optima a bugetului', 'Remarketing campanii'],
                'price' => '300',
                'unit' => 'RON',
            ],
            'social_media_management' => [
                ...
                'attributes' => ['Postari frecvente pe Facebook si Instagram', 'Creare continut (foto/video)', 'Copywriting', 'Imbunatatire profile Social Media', 'Folosire imagini stock'],
                'price' => '500',
                'unit' => 'RON/Luna',
            ],
            'optimizare_seo' => [
                ...
                'attributes' => ['Optimizare tehnica', 'Optimizare cuvinte cheie', 'Optimizare imagini', 'Analiza competitori', 'Consultanta', 'Monitorizare cuvinte cheie', 'Research backlink-uri', 'Raporturi lunare'],
                'price' => '350',
                'unit' => 'RON',
            ],
            'copywriting' => [
            ...
            'materiale_promotionale' => [
                ...
                'attributes' => ['Tricouri, Sepci, Geci, Pantaloni', 'Bannere', 'Servicii de brodura',' Tablouri', 'Articole Sublimabile'],
                'price' => '30',
                'unit' => 'RON/Bucata',
            ],
        ];
